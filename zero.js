// p5
// function setup() {
//   let p5canvas = createCanvas(windowWidth *2  + 200, windowHeight * 2 + 200);
...
//   else {
//     // blendMode(OVERLAY);
//     fill(220*sin(mouseX/600*PI), 250, 250*cos(mouseY/300*PI), 60);
//     ellipse(mouseX, mouseY, random(100,200));
//     noErase();
//   }
// }
...
//   cd.style.transform = "translate(0%, 0%)";
  ...
  $( function() {
    ...
    $( "#draggable10" ).draggable({ snap: false });
...
// P5
 function setup() {
  let p5canvas = createCanvas(5000, 3000);
  p5canvas.position(-200, -200);
  frameRate(60);
}
